...
class MY_Controller extends MX_Controller {
	...
	private function _setup()
	{
		...
		$this->mPageAuth        = empty($config['page_auth'])         ? array() : $config['page_auth'];
			...
			// echo $this->mBaseUrl."<br>";
			// echo $this->mSiteName."<br>";
			// echo $this->mPageTitlePrefix."<br>";
			// echo $this->mPageTitle."<br>";
			// print_r($this->mMenu)."<br>";
			 // print_r($this->mMetaData)."<br>";
			 // print_r($this->mScripts)."<br>";
			//print_r($this->mStylesheets)."<br>";
			//print_r($this->mPageAuth)."<br>";
    ...
    //
		...
		// mCtrler hace referencia al controlador que llamamos del url (productos, quienes somos  etc)
